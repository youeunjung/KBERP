...
<body>
	...
	<div class="cont_wrap">
		...
		<div class="cont_area">
			<!-- 여기부터 쓰면 됨 -->
		<form action="slrSpcfctnList" id="backForm" method="post">
		...
		<input type="hidden" id="stndrYearMonth" name="stndrYearMonth" value="${param.stndrYearMonth}">
		<input type="hidden" name="top" value="${param.top}">
		<input type="hidden" name="menuNum" value="${param.menuNum}">
		<input type="hidden" name="menuType" value="${param.menuType}">
...
<div align="right" style="width:900px; height:10px; margin-top : 9px;"></div>
...
<table style="width: 450px; height:20px; font-size:10.5pt; margin-bottom:15px;">
    <tbody>
        ...
        <tr>
			...
			<div class="cmn_btn_ml" id="listBtn">확인</div>
			</div>
			</form>
		</div>
	</div>
